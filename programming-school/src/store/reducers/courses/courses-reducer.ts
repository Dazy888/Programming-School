...
const initialState = {
    python: {
        preview: {
            ...
            imgPath: '/courses/previews/python.png',
            time: '10 months',
            path: 'python',
        },
        course: {
    ...
    fullstack_python:  {
        preview: {
            ...
            imgPath: '/courses/previews/fullstack-python.png',
            time: '10 months',
    ...
    web: {
        preview: {
            ...
            imgPath: '/courses/previews/web.png',
            time: '9 months',
            path: 'web',
        },
        course: {
    ...
    fullstack_php: {
        preview: {
            ...
            imgPath: '/courses/previews/fullstack-php.png',
            time: '10 months',
            path: 'fullstack-php',
        },
        course: {
    ...
    frontend: {
        preview: {
            ...
            imgPath: '/courses/previews/frontend.png',
            time: '7 months',
            path: 'frontend'
        }
    } as CourseI,
    frontend_pro: {
        preview: {
            ...
            imgPath: '/courses/previews/frontend-pro.png',
            time: '10 months',
            path: 'frontend-pro',
        },
        course: {
    ...
    fullstack_js: {
        preview: {
            ...
            imgPath: '/courses/previews/fullstack-js.png',
            time: '10 months',
            path: 'fullstack-js',
        },
        course: {
    ...
    php_pro: {
        preview: {
            ...
            imgPath: '/courses/previews/php-pro.png',
            time: '7 months',
            path: 'php-pro',
        },
        course: {
    ...
    c_plus_plus: {
        preview: {
            ...
            imgPath: '/courses/previews/c-plus-plus.png',
            time: '7 months',
            path: 'c-plus-plus',
        },
        course: {
    ...
    android: {
        preview: {
            ...
            imgPath: '/courses/previews/android.png',
            time: '7 months',
            path: 'android',
        },
        course: {
    ...
    ios: {
        preview: {
            ...
            imgPath: '/courses/previews/ios.png',
            time: '6 months',
            path: 'ios',
        },
        course: {
    ...
    mobile: {
        preview: {
            ...
            imgPath: '/courses/previews/mobile.png',
            time: '7 months',
            path: 'mobile',
        },
        course: {
    ...
    flutter: {
        preview: {
            ...
            imgPath: '/courses/previews/flutter.png',
            time: '6 months',
            path: 'flutter',
        },
        course: {
    ...
    java: {
        preview: {
            ...
            imgPath: '/courses/previews/java.png',
            time: '6 months',
            path: 'java',
        },
        course: {
    ...
    java_pro: {
        preview: {
            ...
            imgPath: '/courses/previews/java-pro.png',
            time: '11 months',
            path: 'java-pro',
        },
        course: {
    ...
    cyber_security: {
        preview: {
            ...
            imgPath: '/courses/previews/cyber-security.png',
            time: '1 year',
            path: 'cyber-security'
        }
    } as CourseI,
    devops: {
        preview: {
            ...
            imgPath: '/courses/previews/devops.png',
            time: '7 months',
            path: 'devops'
        }
    } as CourseI,
    devops_pro: {
        preview: {
            ...
            imgPath: '/courses/previews/devops-pro.png',
            time: '1 year',
            path: 'devops-pro'
        }
    } as CourseI,
