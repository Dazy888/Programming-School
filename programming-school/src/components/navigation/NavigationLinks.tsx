...
const NavigationLinksComponents = () => {
    ...
    return(
        <nav className={`${navClass} w-96 duration-500 overflow-hidden text-white`}>
            <span onClick={burgerListener} className={`${styles['burger']} w-fit text-3xl mt-10 mb-5 mx-auto hidden`}>
