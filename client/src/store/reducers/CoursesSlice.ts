...
const commonItems = {
    ...
    program: {
        pythonBasic_1: {
            ...
            listItems: [
                'Introduction', 'Basics of working with Python', 'Operators, expressions', 'Conditional if statement, branches',
                'Conditional if statement: continuation', 'While loop', 'For loop: loops with a counter', 'The for loop: features of working with range',
                'The for loop: working with strings', 'Nested loops', 'Numbers. The types are int and float', 'Functions: start', 'Float features'
            ]
        },
        pythonBasic_2: {
            title: 'Fundamentals of Python. Part 2',
            listItems: [
                'Installing and configuring the IDE', 'Basic collections. Lists', 'List: methods for working with lists', 'List views',
                'Basic collections. Strings', 'Basic collections. Dictionaries', 'Basic collections. Tuples', 'Functions: continued',
                'Working with files', 'Exceptions: dealing with errors', 'Introduction to OOP', 'Basic principles of OOP', 'Iterators and generators',
                'Decorators: basic level', 'Deep class work and built-in decorators', 'Decorators: advanced level', 'Functions: end', 'Libraries for working with data'
            ]
        },
        pythonAdvanced: {
        ...
        php: {
            ...
            listItems: [
                ...
                'Working with files and with the network', 'Error handling, Exceptions and logs', 'HTTP protocol', 'Handling GET and POST requests, intro, cookies and sessions',
                'REST and RESTful APIs', 'SQL query language', 'Working with databases in PHP', 'Laravel framework'
            ]
        },
        laravel: {
        ...
        bash: {
            ...
            listItems: [
                'What is command line', 'Working with files and folders', 'Authorization and access rights', 'Processes, services and tasks',
                'Configuration and tools', 'Writing scripts in Bash', 'Using bash on an example of setting up a web server'
            ]
        },
        git: {
            title: 'Git version control system',
            listItems: [
                'Program code versions', 'Installing Git', 'Index and partial commits', 'Version comparison', 'Undo changes and rollback versions',
                'Repositories and teamwork', 'Branches - creation and management', 'Merging and conflict resolution', 'Useful tools', 'Rules for working with Git'
            ]
        },
        sql: {
        ...
        iosBasic: {
            ...
            listItems: [
                ...
                'Swift development basics. Working with dictionaries', 'Fundamentals of UI development', 'Classes and structures in Swift', 'OOP',
                'Protocols', 'The layout of UI elements. Using Enum', 'Working with layouts', 'Life cycle and navigation', 'Lists', 'Libraries. access modifiers',
                'Version control', 'Multithreading', 'Network requests. Part 1', 'Network requests. Part 2', 'Storage of user data', 'Animations',
                'Modern approaches to development', 'Creating navigation in code', 'Publishing an app to the App Store'
            ]
        },
        iosAdvanced: {
            ...
            listItems: [
                'Introduction to SwiftUI', 'SwiftUI. Element layout', 'SwiftUI. Navigation', 'SwiftUI. Widgets', 'SwiftUI. Layout of elements',
                'SwiftUI. Working with State', 'SwiftUI. Animation', 'combine. Part 1: The Basics', 'What is a combine. Part 2', 'What is a combine. Part 3',
                'What is a combine. Part 4', 'Testing', 'Xcode Optimization and Tools', 'Push Notifications', 'Design patterns', 'Team final project'
            ]
        },
        kotlin: {
        ...
        devopsStart: {
            ...
            listItems: [
                'Introduction to Linux', 'Linux: first steps', 'Users and Files. Introduction to Vim', 'Preparation for writing scripts in Bash',
                'Writing scripts in Bash', 'Writing scripts in Bash. Continuation', 'Writing scripts in Bash. Cycles', 'Writing scripts in Bash. Cycles: continued',
                'Writing scripts in Bash. Conclusion', 'World Wide Web', 'Initialization systems', 'Cryptography. HTTPS', 'Working with devices in Linux',
                'Introduction to databases', 'Database. Continuation', 'Introduction to networks', 'Continuation of acquaintance with data transfer',
                'Completion of acquaintance with networks', 'We collect LAMP', 'Deb packages', 'Monitoring and diagnostics', 'Monitoring and diagnostics. Continuation',
                'Firewall', 'Virtualization', 'Tunnels'
            ]
        },
        devopsBasic: {
    ...
    projects: {
        ...
        accountManagement: {
            ...
            listItems: [
                'deploy a certification authority for issuing certificates', 'create and configure a VPN server', 'set up monitoring',
                'make a backup', 'prepare documentation', 'plan infrastructure development'
            ]
        }
    },
    speakers: {
        ...
        vasyanovich: {
            ...
            additionalInfo: [
                '2016–2021. Freelance layout designer. Created more than 50 commercial projects', 'Since 2021 — layout designer at Lenta',
                'Leads the MaxGraph YouTube channel, talks about front-end development'
            ]
        },
        tiunov: {
            imgSrc: 'web/3',
            ...
            additionalInfo: [
                'Author of JavaScript courses', 'Member of the program committee of the Frontendconf conference',
                '2011–2012. Web Developer at OUTSIDE. Developed a system for online synchronization of data from car dealer websites',
    ...
    questions: {
        ...
        default_questions: [
            {
                ...
                text: 'Of course! With the right approach to learning, independent expansion of horizons and timely completion of practical tasks, you can achieve results even without special basic knowledge. Experienced tutors will help you with everything, who will accompany you throughout the course'
            },
            {
                title: 'What is the training schedule on the platform? Can you combine it with work?',
                text: 'You can study the course materials in a mode convenient for you, combine learning on the platform with work and personal life. Moreover, all videos will be available at the end of the course, so you can brush up on your knowledge at any time'
            },
            {
                title: 'How many hours per week will I need to devote to training on the platform?',
                text: 'Everything depends on you. On average, platform users spend 3 to 5 hours a week'
            },
            {
        ...
        system_requirements: {
            ...
            listItems: [
                'Operating system: Windows 8.0 or higher, macOS 10.12 (macOS Sierra) or higher.', 'Processor: 4-core with a frequency of 2.5 GHz or higher',
                'RAM: from 4 GB.', 'Video Card: Intel HD Graphics 4000, Nvidia 330m or ATI Radeon HD 4850 or higher',
                'It is desirable, but not necessary, that the memory be on an SSD', 'Screen resolution: preferably 1920x1080', 'Internet access'
            ]
        },
        soft: {
...
const frontend = {
    ...
    skills: [
        ...
        },
        {
            ...
            text: 'Master two popular programming languages at once. With JavaScript you will create interactive models, and with TypeScript you will be able to quickly and reliably develop complex projects'
        },
        {
    ...
    programs: [
        commonItems.program.webLayout, commonItems.program.jsBasic, commonItems.program.frameworks, commonItems.program.nodejs,
        commonItems.program.typescript, commonItems.program.careerCourse, commonItems.program.employment, commonItems.program.additionalCourses
    ],
    speakers: [
        commonItems.speakers.mikheev, commonItems.speakers.tiunov, commonItems.speakers.kornienko, commonItems.speakers.vasyanovich,
        commonItems.speakers.avdeev, commonItems.speakers.bondarovich, commonItems.speakers.savchenko, commonItems.speakers.mirotin,
        commonItems.speakers.pozdnyakov, commonItems.speakers.klimonova, commonItems.speakers.kuznetsov, commonItems.speakers.borzunov
    ],
    cv: {
        skills: [
    ...
    questions: [
        ...
        },
        {
            ...
            terms: [
                ...
                {
                    title: 'TypeScript',
                    text: 'a programming language based on JavaScript that extends its capabilities and allows you to quickly develop reliable, stable and secure systems'
                },
                {
                    title: 'Node.js',
                    text: 'a JavaScript-based platform that allows you to work on the back-end of the application'
                }
            ]
        },
        {
...
const initialState: CoursesState = {
    ...
    courses: {
            ...
            course: {
                title: {
                    ...
                    features: [
                        ...
                        commonItems.title.guarantees,
                        commonItems.title.getJobInSixMonths
                    ]
                },
                market: {
                ...
                program: {
                    ...
                    programItems: [
                        ...
                        },
                        {
                            ...
                            listItems: [
                                'Introduction to web frameworks', 'Introduction to Django', 'Handling requests in Django', 'Database and models', 'Forms',
                                'Working with files', 'Testing', 'Authentication and authorization', 'Admin', 'Localization and internationalization', 'Access rights',
                                'Documentation', 'Optimization', 'Data export'
                            ]
                        },
                        {
                ...
                speakers: [
                    commonItems.speakers.shulaev,
                    commonItems.speakers.krotov,
                    {
                        imgSrc: '/python/1',
                        fullName: 'Roman Bulgakov',
                        text: 'Computer science and programming teacher with more than 5 years of experience'
                    },
                    {
                        imgSrc: '/python/2',
                        fullName: 'Alexei Polovinkin',
                        text: 'AGIMA Python-teamlead. Work experience - more than 7 years'
                    },
                    {
                        imgSrc: '/python/5',
                        fullName: 'Nikita Nesterenko',
                        text: 'Project manager and chief development engineer at Sberbank. Work experience - more than 5 years'
                    },
                    {
                        imgSrc: '/python/6',
                        fullName: 'Alexei Nekrasov',
                        text: 'Leader of the Python direction at MTS, Program Director of the Python direction. Work experience - more than 6 years'
                    }
                ],
                cv: {
            ...
            course: {
                title: {
                    ...
                    features: [
                        ...
                        commonItems.title.fourProjectsInPortfolio
                    ]
                },
                market: {
                ...
                for_who: [
                    ...
                    },
                    {
                        ...
                        text: 'You will increase your chances of getting a high-paying job, get advice from experienced speakers and learn how to develop as a fullstack programmer and work on complex and expensive projects'
                    }
                ],
                skills: [
                    {
                ...
                program: {
                    ...
                    programItems: [
                        commonItems.program.webLayout, commonItems.program.jsBasic, commonItems.program.pythonBasic_1, commonItems.program.pythonBasic_2,
                        commonItems.program.pythonAdvanced, commonItems.program.frameworks, commonItems.program.employment, commonItems.program.additionalCourses
                    ]
                },
                projects: [
                    {
                        title: 'Landing',
                        text: 'You create a landing page based on the brief to consolidate the knowledge gained in the course'
                    },
                    {
                        title: 'User interface',
                        text: 'You will develop a user interface similar to Instagram'
                    },
                    {
                        title: 'Space game',
                        text: 'You will write a behavior algorithm for space drones that collect fuel from asteroids'
                    }
                ],
                speakers: [
                    {
                        fullName: 'Vadim Shandrinov',
                        text: 'Python developer with over 16 years of experience. Block "Python Basic"'
                    },
                    {
                        fullName: 'Anton Turin',
                        text: 'Senior developer at Twitter'
                    },
                    {
                        fullName: 'Nikita Levashov',
                        text: 'Co-founder and technical director at Angry Developers'
                    },
                    commonItems.speakers.yakovushen,
                    commonItems.speakers.shulaev,
                    commonItems.speakers.krotov
                ],
                cv: {
            ...
            course: {
                ...
                skills: [
                    ...
                    },
                    {
                        ...
                        text: 'Master two popular languages at once - using JavaScript you will create interactive models, and use PHP to program the server side of sites'
                    },
                    {
                ...
                program: {
                    ...
                    programItems: [
                        ...
                        commonItems.program.jsBasic,
                        {
                            ...
                            listItems: [
                                'Vue basics', 'Project creation', 'Catalog', 'Pagination and filtering', 'Product page', 'Basket',
                                'Working with API. List of goods', 'Working with API. Making an order', 'Deploy', 'Vue 3.0',
                                'Final project: write an online store using the Vue.js framework. to choose from, it will be either a Moire premium lingerie store or a Technosavr electronics store'
                            ]
                        },
                        {
                            ...
                            listItems: [
                                'Introduction to React', 'Project creation', 'TypeScript', 'Components on the example of a Reddit news card',
                                'Hooks and functional programming', 'More about components and an introduction to component testing',
                                'Introduction to component testing', 'Working with a public API on the example of Reddit', 'API + Context',
                                'Portal and form', 'An introduction to Redux using the comment field as an example',
                                'Using Redux-Thunk on an example of loading a user profile', 'Forms on the example of comments and post cards',
                                'Endless lists on the example of a feed of posts', 'Routing', 'Deploy', 'Bonus module: Mobx, effector and other redux alternatives',
                        ...
                        },
                        {
                            ...
                            listItems: [
                                'Introduction to Angular', 'Creation of UI Kit', 'Catalog', 'Routing', 'Service architecture in Angular', 'HTTP Advanced',
                                'RXJS: product search', 'Forms in Angular', 'Product page', 'Application improvement', 'RXJS & Components Advanced: Shopping Cart',
                                'Testing', 'Ways to organize data exchange', 'Final project: develop a task tracker with a timer using the Pomodoro method'
                            ]
                        },
                        {
                        ...
                        },
                        {
                            ...
                            listItems: [
                                'Introduction to PHP programming', 'Variables, numbers and boolean', 'Conditional operators and Boolean algebra',
                                'Strings and arrays', 'Cycles', 'Functions: creation and use', 'Recursion, callback and anonymous functions',
                                'Classes, methods and objects', 'Inheritance and abstract classes', 'Interfaces and polymorphism',
                                'Access modifiers, getters and setters', 'HTML/CSS', 'Connecting frontend to backend', 'Separation of the application into files',
                                'Working with files and network', 'Error handling, Exceptions and logs', 'Handling GET and POST requests, Intro, Cookie and Session',
                                'REST and RESTful APIs', 'SQL query language', 'Working with databases in PHP', 'Laravel framework',
                                'Dropbox file storage. Write application components from scratch in pure PHP - without using frameworks'
                            ]
                        },
                        {
                ...
                speakers: [
                    commonItems.speakers.kornienko,
                    commonItems.speakers.vasyanovich,
                    commonItems.speakers.tiunov,
                    commonItems.speakers.avdeev,
                    commonItems.speakers.molescu,
                    commonItems.speakers.pozdnyakov,
                    commonItems.speakers.bondarovich,
                    commonItems.speakers.savchenko,
                    commonItems.speakers.mirotin,
                    commonItems.speakers.ignatiev,
                    commonItems.speakers.pilipenko,
                    {
                        imgSrc: 'web/5',
                ...
                cv: {
                    ...
                    projects: [
                        '1. Art gallery landing page / podcast platform', '2. CRM system', '3. Online store / task tracker', '4. Cloud file storage',
                        '5. Frontend part of the online store', '6. Frontend part of the banking service'
                    ],
        ...
        fullstackPHP: {
            ...
            course: {
                ...
                program: {
                    ...
                    programItems: [
                        commonItems.program.webLayout, commonItems.program.jsBasic, commonItems.program.php,
                        commonItems.program.laravel, commonItems.program.frameworks, commonItems.program.additionalCourses
                    ]
                },
                projects: [
                    {
                        title: 'One page website',
                        text: 'You will create an adaptive one-page website on the subject given by the teacher'
                    },
                    {
                        title: 'Online store',
                        text: 'You are designing web pages for an online furniture store'
                    }
                ],
                speakers: [
                    {
                        fullName: 'Vasiliy Grudistov',
                        text: 'Chief executive officer in InstaDev'
                    },
                    {
                        fullName: 'Michael Volkov',
                        text: 'Technical director Qsoft'
                    },
                    commonItems.speakers.pilipenko,
                    commonItems.speakers.yakovushen
                ],
            ...
            course: {
                ...
                cv: {
                    ...
                    projects: [
                        ...
                        '5. Construction company website', '6. Tour operator website', '7. Online store of electronic equipment/premium lingerie',
                        '8. Frontend part of a streaming service in TypeScript'
                    ],
        ...
        fullstackJs: {
            preview: { profession: 'Fullstack JavaScript developer', time: '10 months', path: 'fullstack-js' },
            course: {
                title: {
                ...
                skills: [
                    ...
                    {
                        title: 'Work with frameworks',
                        text: 'Learn ReactFramework.js, Vue.js or Angular and learn how to create dynamic interactive user models'
                    },
                    {
                ...
                program: {
                    ...
                    programItems: [
                        commonItems.program.webLayout, commonItems.program.jsBasic, commonItems.program.nodejs, commonItems.program.frameworks,
                ...
                projects: [
                    {
                        title: 'Landing',
                        text: 'Build a landing page based on a brief from a customer using HTML and CSS'
                    },
                    {
                        title: 'User interface',
                        text: 'Develop a web application using JavaScript'
                    },
                    {
                        title: 'Note service',
                        text: 'Develop the frontend and backend for a personal note service using Node.js'
                    },
                    {
                        title: 'Online store',
                        text: 'Create a full-fledged online store using the Vue.js framework'
                    },
                    {
                        title: 'Integration with Reddit',
                        text: 'Set up the integration of posts from the Reddit news site using the ReactFramework.js framework'
                    },
                    {
                        title: 'Online store',
                        text: 'Develop a full-fledged online store on the Angular framework'
                    }
                ],
                speakers: [
                    commonItems.speakers.bondarovich, commonItems.speakers.savchenko, commonItems.speakers.kuznetsov, commonItems.speakers.kornienko,
                    commonItems.speakers.vasyanovich, commonItems.speakers.yakovushen, commonItems.speakers.mirotin, commonItems.speakers.klimonova
                ],
                cv: {
            ...
            course: {
                title: {
                    ...
                    features: [
                        ...
                        commonItems.title.threeProjectsInPortfolio,
                        commonItems.title.guarantees,
                        commonItems.title.durationSevenMonths
                    ]
                },
                market: {
                ...
                speakers: [commonItems.speakers.ignatiev, commonItems.speakers.molescu],
                cv: {
                    salary: 'From 90.000 USD',
                    skills: [
                ...
                questions: [
                    ...
                    {
                        title: 'Will I be able to communicate with speakers?',
        ...
        android: {
            ...
            course: {
                title: {
                    ...
                    features: [
                        commonItems.title.getJobInSevenMonths,
                        commonItems.title.forBeginners,
                        {
                ...
                program: {
                    ...
                    programItems: [
                        ...
                        },
                        {
                            ...
                            listItems: [
                                'Introduction to the profession', 'Beginning of work', 'Layout', 'Components', 'ConstraintLayout', 'Project resources', 'Application screens',
                                'Fragments', 'Animation', 'Application localization', 'Life cycle', 'Fundamentals of data storage', 'Presentation layer architecture',
                                'Work with the network (Retrofit)', 'Working with the database (Room)', 'Project architecture', 'Working with lists',
                                'Working with protected OS partitions', 'Location work', 'Firebase', 'Preparing for release'
                            ]
                        },
                        {
                ...
                projects: [
                    {
                        title: 'Distribution center emulato',
                        text: commonItems.projects.texts.emulator
                    },
                    {
                        title: 'Application for finding movies and series',
                        text: commonItems.projects.texts.finder
                    },
                    {
                        title: 'Team Internship: Mobile App for Android',
                        text: commonItems.projects.texts.teamProject
                    }
                ],
                speakers: [
                    commonItems.speakers.lisakov,
                    commonItems.speakers.alexandrov,
                    commonItems.speakers.martynenko,
                    commonItems.speakers.machikhin,
                    commonItems.speakers.firsov,
                    commonItems.speakers.malykh,
                    commonItems.speakers.pilipenko,
                    commonItems.speakers.shadrin,
                    commonItems.speakers.ovchinnikov,
                    commonItems.speakers.rybakov,
                    {
                        imgSrc: 'android/3',
                        fullName: 'Artyom Bagritsevich',
                        text: 'In development for 11 years. Chief Android Developer'
                    },
                    {
                        imgSrc: 'android/4',
                        fullName: 'Alexandr Oplachnikov',
                        text: 'Senior Android Developer'
                    },
                    {
                        imgSrc: 'android/10',
                        fullName: 'Alexandr Ageychenko',
                        text: 'Lead Android-developer, Tinkoff'
                    }
                ],
                cv: {
            ...
            course: {
                ...
                program: {
                    ...
                    programItems: [
                        ...
                        {
                            title: 'Final work. Application for working with Yandex Disk',
                        },
                ...
                speakers: [
                    commonItems.speakers.kudryavtsev, commonItems.speakers.aniskov, commonItems.speakers.nikolaev, commonItems.speakers.sotsky,
                    commonItems.speakers.pilipenko, commonItems.speakers.rybakov, commonItems.speakers.malykh, commonItems.speakers.shadrin
                ],
                cv: {
                    salary: 'From 80.000 USD',
                    skills: [
        ...
        mobile: {
            ...
            course: {
                ...
                skills: [
                    ...
                    {
                        title: 'Design models and animations',
                        text: 'You will lay out basic UI elements and assemble them on the screen. Learn how to create custom models, screen transitions and animations'
                    },
                    {
                        title: 'Set up the client-server part',
                        text: 'You will connect models and program logic into a single whole, learn how to communicate with databases using SQL and make network queries. Connect third party services to your apps'
                    },
                    {
                        title: 'Timer applications',
                ...
                program: {
                    ...
                    programItems: [
                        ...
                        commonItems.program.kotlin,
                        {
                            ...
                            subtitle: 'You will go through the basics of Android development: learn how to make screens, animate models, program logic, work with data and the network. Write over 7 mini-projects, including a quiz app, gallery, news feed, and point of interest map',
                            listItems: [
                                'Beginning of work', 'Layout', 'Components', 'ConstraintLayout', 'Project resources', 'Application screens', 'Fragments',
                                'Animation', 'Application localization', 'Life cycle', 'Fundamentals of data storage', 'Presentation layer architecture',
                                'Work with the network (Retrofit)', 'Working with the database (Room)', 'Project architecture', 'Working with lists',
                                'Working with protected OS partitions', 'Location work', 'Firebase', 'Preparing for release', 'Final work. Application for finding movies and series'
                            ]
                        },
                        {
                            ...
                            subtitle: 'Master advanced development techniques — learn how to change models. Optimize performance, get familiar with design patterns, and immerse yourself in the concept of reactive programming',
                            listItems: [
                                'We create our own View and animations', 'Working with lists', 'Declarative UI', 'Running tasks in the background: practice',
                                'Advanced dependency injection. Dagger 2', 'Application building patterns', 'Presentation layer patterns', 'Testing',
                                'Application exit', 'Memory leaks and static analyzers', 'Code review at an advanced level', 'RxJava. Basics',
                                'RxJava. Part 2. Operators', 'Final work. Team app development'
                            ]
                        },
                        {
                            title: '✦ Job placement with Career Center',
                ...
                projects: [
                    {
                        title: 'Profession iOS developer. Yandex Disk analogue',
                        text: commonItems.projects.texts.yandexDisc
                    },
                    {
                        title: 'Profession Android developer. Application for finding movies and series',
                        text: commonItems.projects.texts.finder
                    },
                    {
                        title: 'Profession Android developer. Console application for the logistics center',
                        text: commonItems.projects.texts.emulator
                    },
                    {
                        title: 'Team Internship: Mobile App for Android',
                ...
                speakers: [
                    commonItems.speakers.kudryavtsev, commonItems.speakers.aniskov, commonItems.speakers.nikolaev, commonItems.speakers.sotsky,
                    commonItems.speakers.lisakov, commonItems.speakers.alexandrov, commonItems.speakers.martynenko, commonItems.speakers.machikhin,
                    commonItems.speakers.firsov
                ],
                questions: [
                    {
            ...
            course: {
                ...
                skills: [
                    ...
                    },
                    {
                        ...
                        text: 'Master Figma. You will be able to customize user models and develop design for application pages'
                    },
                    {
                    ...
                    programItems: [
                        {
                            ...
                            listItems: [
                                'Introduction', 'Fundamentals of Dart', 'Flutter', 'Stateful/Stateless Widget', 'Material/Cupertino', 'Layout', 'Navigation',
                                'Asynchrony', 'Working with forms', 'Testing/Advanced Testing', 'Firebase', 'Flutter project architecture', 'State management',
                                'Advanced widgets', 'Multiplatform solutions', 'Application theme', 'Animations', 'Working with media, maps and Web View',
                                'Integration with native', 'Persistence data', 'DevTools', 'Flutter under the hood'
                            ]
                        },
                        {
                            ...
                            listItems: [
                                'Introduction', 'Variables', 'Functions', 'Conditions and cycles', 'Collections', 'Objects', 'Object-oriented programming. Part 1',
                                'Object-oriented programming. Part 2', 'Object-oriented programming. Part 3', 'Type comparison', 'Exceptions', 'Coroutines', 'Threads',
                                'Introduction to the profession', 'Beginning of work', 'Layout', 'Components', 'ConstraintLayout', 'Project resources', 'Application screens',
                                'Animation', 'Application localization', 'Life cycle', 'Fundamentals of data storage', 'Presentation layer architecture', 'Networking. retrofit',
                                'Working with DB. Room', 'Working with data arrays', 'Working with protected OS partitions', 'Location work', 'Firebase', 'Preparing for release'
                            ]
                        },
                        {
                            ...
                            listItems: [
                                ...
                                'Autolayout, Constrains, StakViews', 'Tables and collections', 'Creating your own UI components',
                                'Interaction with the server, json parsing. Standard tools and libraries', 'Animation from A to Z', 'Data storage: Realm, CoreData, UserDefaults, version control',
                                'Functional programming', 'Signing and submitting apps to the App Store. iTunes connect overview'
                            ]
                        },
                        {
                            title: '✦ Job placement with Career Center'
                        },
                        {
                            ...
                            listItems: [
                                ...
                                'Figma from zero to PRO. You will learn how to work in the most popular service for creating models',
                                'Agile: Scrum and Kanban in product development. You will learn how to work in a development team on the main methodologies for maintaining digital products',
                                'Presentation of projects. You will learn how to prepare presentations of your projects and pitch them in front of an audience',
                                'Git version control system. You will learn how to work with code versions. You can compare and undo them using the Git system',
                                "SQL query language. You'll learn a popular language that will help you speed up your queries",
                                '"Career and development for a programmer". You will understand where to grow in the profession and how to develop as a programmer'
                            ]
                        }
                    ]
                },
                ...
                speakers: [
                    {
                        fullName: 'Anatoly Kirsanov',
                        text: 'Practicing speaker and Flutter developer'
                    },
                    {
                        fullName: 'Alexander Denisov',
                        text: 'Chief Software Engineer, Co-Head of Flutter Competency'
                    },
                    {
                        fullName: 'Vladimir Polyukhovich',
                        text: 'Senior Software Developer'
                    },
                    {
                        fullName: 'Nikita Arkhipov',
                        text: 'Founder of mobile app studio Anvics'
                    },
                    {
                        fullName: 'Mikhail Nikipelov',
                        text: 'Art Director at Distillery'
                    },
                    {
                        fullName: 'Pavel Yarets',
                        text: 'Our speaker'
                    },
                    {
                        fullName: 'Pavel Gorshkov',
                        text: 'Former Design Director at Red_mad_robot'
                    },
                    commonItems.speakers.ovchinnikov,
                    commonItems.speakers.alexandrov,
                    commonItems.speakers.rybakov,
                ...
                cv: {
                    salary: 'From 90.000 USD',
                    skills: [
                        'Creation of mobile applications according to platform guidelines', "Ability to understand other people's code",
                        'Working with API, including social networks', 'Creating Blocks in Swift or Kotlin', 'Working with multithreading in applications',
                        'Uploading the application to the store', 'Experience in designing client-server applications', 'Knowledge of Flutter and Dart',
                        'Working with Reactive Libraries', 'Working with Git Version Control', 'Ability to set and meet deadlines', 'Mobile Application Testing'
                    ],
        ...
        java: {
            ...
            course: {
                    ...
                    programItems: [
                        {
                            ...
                            listItems: [
                                'Project 1. Game "Guess the number". The program will guess the number that the user has guessed',
                                'Project 2. A calculator that can perform basic arithmetic operations',
                                'Project 3. Applications for the accounting of goods and books in different stores',
                                'Project 4. Program for managing the operation of a passenger elevator',
                                'Project 5. An application that converts text into different encodings', 'Project 6. Phone book application',
                                'Project 7. A program for managing company employees: it can display all employees and sort them by various properties',
                                'Project 8. A navigator application that can be used to find out the duration of trips on the subway',
                                'Project 9. An application that can be used to "pull" statistics on purchases of courses from the database',
                ...
                speakers: [commonItems.speakers.pilipenko, commonItems.speakers.ovchinnikov],
                cv: {
                    salary: 'From 80.000 USD',
                    skills: [
                        'I develop web applications in Java', 'Working with file system and databases', 'Testing applications',
                        'Know and apply application design patterns', 'I know the principles of object-oriented programming',
                        "I can read other people's code", 'I apply algorithms to solve problems', 'Working with the Git version control system',
                        'I develop multi-threaded applications', 'Ability to work in a distributed team using the SCRUM methodology',
                    ...
                    programItems: [
                        {
                            ...
                            listItems: [
                                'Introductory module', 'The syntax of the language. Part 1', 'The syntax of the language. Part 2',
                                'Objects and classes. Part 1 Methods and classes', 'Objects and classes. Part 2. Encapsulation',
                                'Objects and classes. Part 3. Static, constants and enum', 'Primitives', 'Numbers and dates', 'Strings',
                                'Arrays and collections', 'Inheritance and polymorphism', 'Features of OOP in Java',
                                'Exceptions, debugging, testing and logging', 'Working with files and network', 'Working with MySQL in Java',
                                'Multithreading', 'HTTP protocol', 'Development of web applications', 'Non-relational databases and queues',
                                'Development of desktop applications', 'Performance and optimization', 'Algorithms', 'Data structures',
                                'Distributed storage and computing', 'Design patterns', 'Preparation for the final project'
                            ]
                        },
                        {
                            title: 'Working with the Spring Framework',
                            listItems: [
                                'Introduction to Spring MVC (XML-based approach)', 'Introduction to Spring MVC (Java-based approach)', 'Development on Spring Boot',
                                'Templates and Thymeleaf', 'Working with data', 'Spring REST API. Part 1', 'Spring REST API. Part 2', 'Spring Application Security',
                                'Testing Spring Applications', 'Spring AOP', 'Integration with external services', 'Preparation for the final project'
                            ]
                        },
                        {
                            ...
                            listItems: [
                                'Teamwork. Flexible management methodologies', 'Teamwork. Interaction tools', 'Development life cycle',
                                'IT architecture. From application to ecosystem', 'Microservices. Organization', 'JVM mechanisms. Memory management',
                                'JVM mechanisms. Compilation', 'JVM mechanisms. Processes and threads', 'Advanced technologies in Java. Exceptions',
                                'Advanced technologies in Java. Generics', 'Advanced technologies in Java. Collections in development',
                                ...
                                'Microservices. Data flow management', 'Microservices. Administration',
                                'Technologies of corporate development. Work with protocols and protection of data transmission channels',
        ...
        cyberSecurity: {
            ...
            course: {
                title: {
                    ...
                    features: [
                        commonItems.title.durationOneYear,
                        {
                ...
                cv: {
                    salary: 'From 90.000 USD',
                    skills: [
                        'Security analysis of web applications and network infrastructure', 'Conducting a security audit', 'Malware analysis',
                        'Development of safety recommendations', 'Conducting penetration tests', 'Advanced Linux Administration',
                        'Preparation of documentation and reports on test results'
                    ],
        ...
        devops: {
            ...
            course: {
                title: {
                    ...
                    features: [commonItems.title.durationSevenMonths, commonItems.title.threeProjectsInPortfolio, commonItems.title.guarantees]
                },
                market: {
                ...
                speakers: [
                    commonItems.speakers.naumenko, commonItems.speakers.zaycev, commonItems.speakers.aquilin,
                    commonItems.speakers.bryukhanov, commonItems.speakers.krylov, commonItems.speakers.dmitriev
                ],
                cv: {
                    salary: 'From 95.000 USD',
                    skills: [
        ...
        devopsPro: {
            ...
            course: {
                ...
                program: {
                    ...
                    programItems: [
                        ...
                        commonItems.program.devopsBasic,
                        {
                            ...
                            listItems: [
                                'Introduction: YAML, Utilities, Git', 'Service Discovery', 'CMS (Configuration Management System). Ansible', 'Docker',
                                'CI/CD: Jenkins, GitLab', 'Monitoring: collection of metrics', 'Monitoring: collection of logs', 'Safety', 'Networks',
                                'Cloud services', 'Final work'
                            ]
                        },
                        commonItems.program.git,
                        commonItems.program.pythonBasic_2,
                        commonItems.program.sql,
                        {
                            title: 'Docker',
                            listItems: [
                                'Core components of Docker', 'Basic Docker Concepts', 'Docker Builder and Dockerfile', 'Additional tools for working with Docker',
                                'Container orchestration', 'How docker works. Inside view', 'Final work'
                            ]
                        },
                        {
                            title: 'Infrastructure platform based on Kubernetes',
                            listItems: [
                                'Introduction to Kubernetes: basic concepts and architecture', 'Core Kubernetes objects', 'Security and access control',
                                'Kubernetes network subsystem', 'Data storage in Kubernetes', 'Templates: Helm and its analogues (Jsonnet, Kustomize)',
                                'HPA', 'Monitoring of cluster components and applications running in it', 'Service mesh. Introduction to Istio and Envoy',
                                'Kubernetes for Continuous Delivery (CI/CD). Integration with CI service', 'Cluster operation', 'Final work'
                            ]
                        },
                        {
                ...
                speakers: [
                    {
                        fullName: 'Ilya Feoktistov',
                        text: 'Head of DevOps at Bling'
                    },
                    {
                        fullName: 'Denis Matveev',
                        text: 'Sysadmin/DevOps at Ignitia AB (Sweden)'
                    },
                    commonItems.speakers.naumenko,
                    commonItems.speakers.zaycev,
                    commonItems.speakers.aquilin,
                    commonItems.speakers.bryukhanov,
                    commonItems.speakers.krylov,
                    commonItems.speakers.dmitriev
                ],
                cv: {
                    salary: 'From 100.000 USD',
                    skills: [
