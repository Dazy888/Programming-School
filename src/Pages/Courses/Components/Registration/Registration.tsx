...
export function Registration({className = ''}: RegistrationPropsType) {
    ...
    const form_ref: any = React.createRef()
    ...
    useEffect(() => {
        let element = form_ref.current.querySelector('.phone-input')
                            ...
                            <Form ref={form_ref}>
                                ...
                                <div className={'form__row flex-property-set_between'}>
                                    <div className={'error-container'}>
                                        ...
                                        <Field className={'phone-input'} minLength={10} maxLength={13} placeholder={'Phone'} type={'text'} name={'phone'} validate={phoneNumberValidator} />
