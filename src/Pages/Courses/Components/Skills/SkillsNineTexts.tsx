...
export function SkillsNineTexts({texts, className}: SkillsTextsType) {
    return(
        <div className={'skills'}>
            ...
            <div className={'skills__row flex-property-set_between'}>
                <Skill className={className} text={texts[6]}/>
                <Skill className={className} text={texts[7]}/>
                <Skill className={className} text={texts[8]}/>
            </div>
        </div>
    )
}