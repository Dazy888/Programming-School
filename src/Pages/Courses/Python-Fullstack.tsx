...
export function PythonFullstack() {
    return(
        <div className={'course-container python-fullstack-course'}>
            <CourseHeader profession={'Python Fullstack-Developer'} titleTxt={titleTxt} imgUrl={'https://248006.selcdn.ru/LandGen/desktop_43712003895f94c163a288e6e9e0e00bbf671110.webp'} time={'1 year'} projects={'4'}/>
        </div>
    )
}