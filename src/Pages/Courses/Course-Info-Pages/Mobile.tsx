...
export function Mobile({header, time, img, for_who, job_name, skills, projects, projects_texts, projects_photographs, classNames = [''], content}: CourseProjectsPropsType & ExtraProjectPropsType) {
    return(
