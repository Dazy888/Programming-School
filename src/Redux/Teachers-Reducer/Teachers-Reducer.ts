...
let initialState = {
    common: {
        ...
        ageychenko: {
            img: 'https://248006.selcdn.ru/LandGen/phone_6146750be373b6dd87f2cd9a4cb9d44a7f62879b1601973869959.png',
            name: 'Alex',
            surname: 'Ageychenko',
    ...
    android: {
        ...
        surnames: ['Phirsov', 'Bagricevich', 'Shadrin']
    } as TeachersType,
    c_sharp: {
