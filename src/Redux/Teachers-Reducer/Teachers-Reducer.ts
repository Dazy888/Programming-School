...
let initialState = {
    python: {
        ...
        names: ['Roman', 'Alex', 'Andrey', 'Sergey', 'Nikita'],
        surnames: ['Bulgakov', 'Polovinkin', 'Shulaev', 'Krotov', 'Nesterenko']
    } as TeachersType,
    android: {
        avatars: [
        ...
        names: ['Alex', 'Artem', 'Olexander', 'Andrey', 'Alex'],
        surnames: ['Phirsov', 'Bagricevich', 'Oplachikov', 'Malyx', 'Ageychenko']
    } as TeachersType,
    ios: {
        avatars: [
        ...
        names: ['Max', 'Nikolay', 'Danilo', 'Andrey', 'Anton'],
        surnames: ['Nikolaev', 'Sockiy', 'Pilipenko', 'Malyx', 'Rybakov']
    } as TeachersType,
    js: {
        avatars: [
        ...
        names: ['Sergey', 'Max', 'Andrey', 'Max', 'Egor'],
        surnames: ['Kornienko', 'Vasiyanovich', 'Grekov', 'Savchenko', 'Yakovushen']
    } as TeachersType,
    cPlusPlus: {
        avatars: [
    ...
    php: {
        ...
        names: ['Dmitry', 'Michael', 'Michael'],
        surnames: ['Ignatiev', 'Molesku', 'Krahmalev']
    } as TeachersType,
    c_sharp: {
        avatar: 'https://248006.selcdn.ru/LandGen/phone_2d8aec3317a76994cd37ff522fd610a57db5706215792671717877.png' as string,
        description: 'Microsoft Certified Developer' as string,
        name: 'Sergey' as string,
        surname: 'Kameneckiy' as string
    }
}
